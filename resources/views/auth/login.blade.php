        ...
        <div class="w-full max-w-md space-y-6">
            ...
            <div class="bg-[#081224]/80 border border-[#0047FF]/20 rounded-3xl p-8 shadow-[0_20px_60px_rgba(0,71,255,0.15)] backdrop-blur-md">
                ...
                <div class="text-center mb-8">
                    <h1 class="font-display font-extrabold text-3xl text-white mb-2">Masuk</h1>
                    <p class="text-[#94A3B8] text-sm">Belum punya akun? <a href="{{ route('register') }}" class="text-[#FF5C00] hover:underline font-semibold">Daftar di sini</a></p>
                </div>
                ...
                <div class="relative mb-6">
                    ...
                    <div class="relative flex justify-center text-xs">
                        <span class="px-3 bg-[#081224] text-[#94A3B8]">Atau gunakan email</span>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                required
                            >
                            <button type="button" onclick="togglePassword()" class="absolute right-3.5 top-1/2 transform -translate-y-1/2 text-[#94A3B8] hover:text-white transition focus:outline-none">
                                <svg class="w-4 h-4" id="eyeOpen" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                                <svg class="w-4 h-4 hidden" id="eyeClosed" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-between text-xs pt-1">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember" class="accent-[#0047FF] rounded w-4 h-4">
                            <span class="text-[#D1D5DB]">Ingat saya</span>
                        </label>
                        <a href="#" class="text-[#FF5C00] hover:underline font-semibold">Lupa password?</a>
                    </div>
